...
/**
 * @author andderV
 * @date 08.02.2024 22:12
 * CrptApi
 */
public class CrptApi implements ICryptApi {
...
interface ICryptApi {
    void createDocument(CrptApi.Document document, String signature) throws InterruptedException;
